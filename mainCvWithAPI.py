...
def mainCV():
    st.title("Object Detection from CVs")
        ...
        with col2:
            if st.button('Detect Objects'):
                with st.spinner('Detecting objects...'):
                    ...
                    response = requests.post("http://127.0.0.1:8085/detect-objects/", files=files)
                    ...
                    for det in detections:
                        ...
                        ocr_response = requests.post("http://127.0.0.1:8085/perform-ocr/", files=files, data=data)
